...
const Sidebar = ({ isOpen ,setIsOpen}) => {
  ...
  const links = [
    ...
    { id: 7, name: "Promotions", icon: promotions, iconFull: promotionsFull ,navigate : "/admin/promotions"},
    { id: 8, name: "Brands", icon: brands, iconFull: brandsFull,navigate:"/admin/brands" },
