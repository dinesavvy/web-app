      ...
      <div className="d-flex gap-20 ">
        ...
        <div className="cardNudge w-100">
          ...
          <div className="nudgePadding w-100">
            ...
            <div className="d-flex gap-8 align-center mb-12">
              ...
              <div className="fs-14 fw-700 gc">{item?.acceptedFollowerList?.length} people accepted</div>
            </div>
            <div className="TagFull">{moment(item?.deactivateAt).format("[Valid till] Do MMMM YYYY")}</div>
          </div>
        </div>
            )
        })}
        ...
        <div className="w-100 card bgGrey d-flex gap-20 align-center">
          ...
          <div>
            ...
            <div className="fs-16">
              <span className="gc fw-700">85%</span> of people who got the nudge
              came in!
            </div>
          </div>
        </div>
