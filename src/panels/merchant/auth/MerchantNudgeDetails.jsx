...
const MerchantNudgeDetails = ({
  ...
  return (
    <>
      {isSidebarOpen && (
        <div className="overlay2" onClick={toggleSidebar}></div>
      )}
      ...
      <div className={`rightSidebar ${isSidebarOpen ? "open" : ""}`}>
        ...
        <div className="overflowSidebar">
          <img className="w-100 merchantImg br10 mb-6" src={businessNudgeDetailsSelector?.data?.data?.image||dish2} alt="" />
          <div className="fs-16 fw-600">{businessNudgeDetailsSelector?.data?.data?.title}</div>
