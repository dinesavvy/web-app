      ...
      <div className="loginFlex ">
        ...
        <div className="d-flex align-center justify-center w-lg-50 loginside overflowy">
          <div className="mx-450 mx-auto">
            <div className="fs-24 fw-700 mb-8 text-center">
              Oops, Your link has expired
            </div>
            <div className="tabGrey text-center">
              No worries, you can easily request a new one! Click the button
              below to get a new link.
            </div>
            <div className="divider"></div>
            <button className="btn w-100 mb-30" type = "submit" onClick={requestNewLink}>Request New Link</button>
          </div>
        </div>
      </div>
    </>
