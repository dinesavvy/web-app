      ...
      <div className="dashboard">
        <div className="tabPadding mb-30">
          <div className="d-flex align-center gap-20 mb-20 w-100">
            <img src={backButton} alt="backButton" className="cursor-pointer" onClick={()=>navigate('/admin/brands')} />
            <div>
        ...
        <div className="tabPadding mb-30">
           ...
           <div className="w-100 d-flex flexDirection h-100 justify-between">
            ...
            <div className="w-100 d-flex flexDirection h-100 justify-between">
              ...
              <input type="text" className="input" placeholder="PEPSI-24x12-005" />
            </div>
            <div className="twoSpace">
              <label htmlFor="name" className="grey mb-10 fs-16 fw-500">
              Description
              </label>
              <textarea className="input" placeholder="Red Bull - 8.4 oz energy drink (12-pack)"></textarea>
