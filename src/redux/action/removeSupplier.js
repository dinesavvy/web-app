...
import { removeSupplierAPI } from "../../services/removeSupplier";
...
const removeSupplierSlice = createSlice({
  name: "removeSupplier",
  initialState: data,
  reducers: {
...
export default removeSupplierSlice.reducer;
export const removeSupplierAction = removeSupplierSlice.actions;
