...
module.exports = {
  ...
  entry: "./src/panels/distributors/index.js", // Entry point for your supplier panel
  output: {
  ...
  devServer: {
    static: path.join(__dirname, "../dist/distributors"), // Serve static files from this directory
